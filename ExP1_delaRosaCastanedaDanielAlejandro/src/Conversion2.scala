...
object Conversion2{
  ...
  def decToBin(numero: Int): Array[Int]={
  ...
  def main(args: Array[String]): Unit ={
   ...
   mosrarArreglo(decToBin(numero))

   println("Numero en binario complemento A1: ")
   mosrarArreglo(complementoA1(decToBin(numero)))
  
   println("Numero en binario complemento A2: ")
   mosrarArreglo(complementoA2(complementoA1(decToBin(numero))))
